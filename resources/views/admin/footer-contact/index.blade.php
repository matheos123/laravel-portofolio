                            ...
                            <form action="{{ route('admin.footer-contact-info.update', 1) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input name="address" value='{{$contactInfo->address}}' type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Phone Number</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input name="phone" value='{{$contactInfo->phone}}' type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Email</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input name="email" value='{{$contactInfo->email}}' type="email" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
