                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Create Footer Useful Links</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{route('admin.footer-useful-link.update',$usefulLink->id)}}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input name="url" value="{{$usefulLink->url}}" type="text"
                                            class="form-control">
                                    </div>
                                </div>
